...
class _SectionsScreenState extends State<SectionsScreen> {
        ...
        if (state is SectionsLoading || state is SectionsInitial) {
          ...
          return Center(
            child: ErrorStateWidget(
              ...
              onRetry: () => context
                  .read<SectionsCubit>()
                  .loadSections(widget.classroomId),
            ),
          );
          ...
          final currentSection =
              sections.isNotEmpty ? sections[selectedSectionIndex] : null;
                        ...
                        background: Container(
                          ...
                          child: Container(
                            ...
                            child: SafeArea(
                              child: Padding(
                                padding:
                                    EdgeInsets.fromLTRB(24.w, 60.h, 24.w, 24.w),
                                child: Column(
                                          ...
                                          BoxShadow(
                                            color: isSelected
                                                ...
                                                : Colors.black.withOpacity(
                                                    isDark ? 0.3 : 0.05),
                                            blurRadius:
                                                isSelected ? 20.r : 10.r,
                                            offset: Offset(
                                                0, isSelected ? 8.h : 4.h),
                                          ),
                                        ],
                                      ),
                                      child: Center(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            final material = lesson.materials.isNotEmpty
                                ? lesson.materials[0]
                                : null;
                            final contentType =
                                material?.type ?? ContentType.file;
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            gradient: LinearGradient(
                                              ...
                                              colors: _getContentTypeGradient(
                                                  contentType, isDark),
                                            ),
                                            borderRadius:
  ...
  void _showLessonDetail(
      BuildContext context, LessonContent lesson, ContentType type) {
...
class _LessonDetailSheetState extends State<LessonDetailSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedSectionIndex =
        context.read<SectionsCubit>().selectedSectionIndex ?? 0;
    final sectionId =
        context.read<SectionsCubit>().sections[selectedSectionIndex].id;
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 12.sp,
                                color:
                                    _getContentTypeColor(widget.type, isDark),
                                fontWeight: FontWeight.w700,
                                letterSpacing: 0.8,
                              ),
                            ),
                                    ...
                                    child: Slider(
                                      ...
                                      onChanged: (value) async {
                                        final position = Duration(
                                          seconds: (_duration.inSeconds * value)
                                              .round(),
                                        );
