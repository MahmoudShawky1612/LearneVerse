...
import 'package:flutterwidgets/features/profile/views/widgets/contributions.dart';
import 'package:flutterwidgets/features/profile/views/widgets/no_profile_widget.dart';
import 'package:flutterwidgets/features/profile/views/widgets/profile_header.dart';
import 'package:flutterwidgets/features/profile/views/widgets/user_comments.dart';
import 'package:flutterwidgets/features/profile/views/widgets/user_contribution_posts.dart';
import 'package:flutterwidgets/features/profile/views/widgets/user_joined_communities.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  void fetchUserContributions() {
    context
        .read<UserContributionsCubit>()
        .fetchContributionsByUser(widget.userId);
  }
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<ProfileCubit, ProfileState>(
          builder: (context, state) {
                        ...
                        children: [
                          Card(
                            ...
                            child: Padding(
                              ...
                              child: BlocBuilder<UserContributionsCubit,
                                  ...
                                  if (state is UserContributionsLoading) {
                                    ...
                                    return Center(
                                        child: ErrorStateWidget(
                                            ...
                                            onRetry: fetchUserContributions));
                          ...
                          if (state is UserPostLoading) {
                            ...
                            return UserPostsScreen(
                              ...
                              onDelete: (post) {
                                context
                                    .read<UserPostCubit>()
                                    .deletePost(widget.userId, post.id);
                              },
                              onEdit: (post, updatedData) {
                                context.read<UserPostCubit>().editPost(
                                    widget.userId, post.id, updatedData);
                              },
                            );
                          }
                          return const SizedBox();
                        ...
                        builder: (context, state) {
                          if (state is UserCommunitiesLoading) {
                            ...
                            return UserJoinedCommunities(
                                communities: _lastLoadedCommunities,
            ...
            return const Center(
              child: NoDataWidget(
                message: 'Looks like this user has no profile yet... 👀',
              ),
            );
          },
        ),
