...
class _CommentItemState extends State<CommentItem> {
  ...
  void initState() {
    ...
    upVoteColor =
    widget.comment.voteType == "UPVOTE" ? const Color(0xFF00E676) : Colors.grey;
    downVoteColor =
    widget.comment.voteType == "DOWNVOTE" ? const Color(0xFFFF1744) : Colors.grey;
    print(widget.comment.voteCounter);
    print(widget.comment.voteType);
  }
                            ...
                            listener: (context, state) {
                              if (state is UpVoteCommentSuccess) {
                                setState(() {
                                  ...
                                  upVoteColor = comment.voteType == "UPVOTE" ? const Color(0xFF00E676) : Colors.grey;
                          ...
                          BlocConsumer<DownvoteCommentCubit, DownVoteCommentStates>(
                            listener: (context, state) {
                              if (state is DownVoteCommentSuccess) {
                                setState(() {
                                  voteCounter = comment.voteCounter;
                                  downVoteColor = comment.voteType == "DOWNVOTE" ? const Color(0xFFFF1744) : Colors.grey;
