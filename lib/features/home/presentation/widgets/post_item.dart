                            ...
                            if (editableAttachments.isNotEmpty) ...[
                              ...
                              GridView.builder(
                                ...
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: editableAttachments.length == 1 ? 1 : 2,
                                  crossAxisSpacing: 12.w,
                                  mainAxisSpacing: 12.h,
                                  childAspectRatio: editableAttachments.length == 1 ? 1.5 : 1.0,
                                ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Options Menu
                      if (isAuthor && isMenuVisible) _buildOptionsMenuForum(colorScheme, context),
                    ],
                  ),
                ),
              ],
          ...
          BlocBuilder<ForumCubit, ForumStates>(
            builder: (context, state) {
              return _buildOptionsItem(
                ...
                Icons.edit_outlined,
                colorScheme.primary,
                state is ForumLoading ? null : () => _showEditPostDialogForum(context),
            ...
            actions: [
              ...
              BlocBuilder<ForumCubit, ForumStates>(
                builder: (context, state) {
                  return ElevatedButton(
                    onPressed: state is ForumLoading ? null : () {
                      context.read<ForumCubit>().deletePost(currentPost.id, currentPost.forumId);
                      Navigator.pop(dialogContext);
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: colorScheme.error,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Options Menu
                if (isAuthor && isMenuVisible) _buildOptionsMenuDumb(colorScheme),
              ],
            ),
          ),
        ],
